...
public class App {
    public static void main(String[] args) {
        Articulo art1 = new Articulo("A101", "Pluma Roja", 888, 0.08);  //Instanciar y //Asignar valores a las propiedades
        System.out.println(art1.toString());
    
        art1.setCant(999);  //Asignar valores a las propiedades
        art1.setPrecioUnit(0.99);   //Asignar valores a las propiedades
        System.out.println(art1.toString());    //Invocar metodo tostring() del objeto
