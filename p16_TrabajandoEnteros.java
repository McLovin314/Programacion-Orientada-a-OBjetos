//p16_TrabajandoEnteros - Tranajando con variables y literales enteras
...
public class p16_TrabajandoEnteros {
    public static void main(String[] args) {
        ...
        System.out.printf("horas, dias en formato octal           :%d - %d\n", horas, dias);
        System.out.printf("horas, dias en formato hexadecimal     :%d - %d\n", horas, dias);
