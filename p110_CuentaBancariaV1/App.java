...
public class App {
    public static void main(String[] args) {
        ...
        else System.out.println("No tienes el saldo sufidiente");
        ...
        miBanco.agregarClientes(mujer);
        miBanco.agregarClientes(new Cliente("claudia", new CuentaBancaria(100000000)));
        miBanco.getClientes().get(3).getCuenta().retira(900000);
        miBanco.getClientes().get(0).getCuenta().deposita(300000);
        miBanco.getClientes().get(1).getCuenta().deposita(300000);
        miBanco.getClientes().get(2).getCuenta().deposita(300000);
