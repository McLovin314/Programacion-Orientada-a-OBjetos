...
public class p70_CalificacionLetra {
    ...
    public static char CalificacionLetra(float prom) {
        char letra = 'X';
    ...
    public static void main(String[] args) {
        ...
        float prom = 0;
        do {
            System.out.println("Dame tu promedio en escala de 1 al 100 "); prom = obj.nextFloat();
        } while (prom <0 || prom >100);

        System.out.println("Tu calificacion con letra es: " + CalificacionLetra(prom));
    }
